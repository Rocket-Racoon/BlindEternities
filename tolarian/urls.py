...
#    path("collections/<uuid:pk>/edit/",         views.CollectionEditView.as_view(),   name="collection-edit"),
#    path("collections/<uuid:pk>/delete/",       views.CollectionDeleteView.as_view(), name="collection-delete"),
#    path("collections/<uuid:pk>/export/",       views.CollectionExportView.as_view(), name="collection-export"),
#    path("collections/<uuid:pk>/import/",       views.CollectionImportView.as_view(), name="collection-import"),
#
#    # Items de colección
#    path("collections/<uuid:pk>/add/",          views.CollectionAddCardView.as_view(),    name="collection-add-card"),
